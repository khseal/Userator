...
return crypto.encrypt("AES-CBC",context.accessKey:sub(1,16),cjson.encode(msg));
end
local function decodeMessage (context,msg)
return cjson.decode(crypto.decrypt("AES-CBC",context.accessKey:sub(1,16),msg));
end
