...
wifiConfig.stationPointConfig.ssid = "ololo"        -- Name of the WiFi network you want to join
wifiConfig.stationPointConfig.pwd =  "ololo"                -- Password for the WiFi network
...
tmr.alarm(1, 8000, tmr.ALARM_SINGLE, function()
